...
public class AnimationController : MonoBehaviour
{
	...
	new public GameObject blockBox;
	...
	// Animation control
	{
		switch (state)
		{
			case CharacterState.Normal:
			 ...
			 if (ThirdPersonControllerNET.strikeBool == false)
			 {
			...
			//anim.CrossFade("Strike", 0f);
				target.CrossFade ("Strike");
			break;
			...
			case CharacterState.Blocking:
				//anim.CrossFade("Block", 0f);
				target.CrossFade ("Block");
			break;	
		}
		
		if(blocking.block == true)
		{
